...
__DEFINE__(1646310199314, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1646310199315,"./event-store":1646310199316}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646310199315, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1646310199316, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1646310199315,"./utils":1646310199317}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646310199317, function(require, module, exports) {
...
return __REQUIRE__(1646310199314);
})()
